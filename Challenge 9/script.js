...
const split_string = hiddenCode.split('');
console.log(split_string)
let codeDecode = '';
for (let i = 0; i < split_string.length; i++) {
    if (split_string[i] !== 'X' && (isNaN(split_string[i]) || split_string[i] % 2 !== 0)) {
        codeDecode += split_string[i];
    }
}
console.log(codeDecode);
// Your code goes here